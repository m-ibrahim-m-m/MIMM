...
responses = {
    ...
    "How do I report a breakdown?": "To report a breakdown, use transaction code 'IW21'create notification. Enter the details of the breakdown in the malfunction Tab inside the notification, including the equipment and fault description.",
...
def get_response(user_input):
    ...
    if similarities[best_match] > 0.98:  # Threshold for similarity
